...
namespace NorthwindPersitance.Migrations
{
    ...
    [Migration("20191031194438_InitialMigration_9")]
    partial class InitialMigration_9
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PersitanceModel.CustomerCustomerDemograph", b =>
                {
                    b.Property<Guid>("CustomerId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("customerCustomerDemographs");
                });
            ...
            modelBuilder.Entity("PersitanceModel.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("PersitanceModel.CustomerCustomerDemograph", b =>
                {
                    b.HasOne("PersitanceModel.Customer", "Customer")
                        .WithMany("CustomerCustomerDemographs")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PersitanceModel.CustomerDemoGraphic", "CustomerDemoGraphic")
                        .WithMany("CustomerCustomerDemographs")
            ...
            modelBuilder.Entity("PersitanceModel.OrderDetail", b =>
                {
                    b.HasOne("PersitanceModel.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PersitanceModel.Product", "Product")
                        .WithMany("OrderDetails")
